...
installed via the command pip install filepath/bbbPackage-1.0-py3-none-any.whl.<br/>
Where filepath corresponds to the path to the folder the .whl file is located in.<br/> 
